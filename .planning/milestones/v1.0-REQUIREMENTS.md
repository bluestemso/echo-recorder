...
### Save Location (SAVE)
- [x] **SAVE-01**: User can choose an output directory during the finalize step before the recording is saved
- [x] **SAVE-02**: If the user does not choose a directory, the recording saves to the configured default save directory
- [x] **SAVE-03**: The default save directory is configurable and persisted across app launches
